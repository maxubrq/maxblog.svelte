...
export const TOPIC_CONTENT: Record<TopicId, TopicData> = {
	science: {
		...
		vi: {
			...
			intro: [
				'Những bài viết này đi theo sự tò mò của mình chứ không phải chương trình học. Chủ đề có thể là một con lắc, số nguyên tố, xác suất, hay một quá trình nào đó thú vị. Vật lý, Toán có lẽ sẽ xuất hiện nhiều nhất vì đó là nơi trực giác của mình mạnh nhất nhưng mục này không bị giới hạn bởi hai môn này.',
				'Mình luôn trung thực về những gì mình không biết. Khi nói không chắc, đó là có chủ ý. Khi dùng một từ kỹ thuật, sẽ có chú thích cụ thể, nhiều từ sẽ có mục trong từ điển.',
				'Nếu bạn tìm thấy lỗi sai, xin hãy cho mình biết. Mình chân thành cảm ơn điều đó.',
			],
			starters: [],
			scratchpad: [],
		},
	...
	tech: {
		...
		vi: {
			...
			intro: [
				'Mình từng là một Senior Software Engineer làm việc trên các hệ thống phân tán: những bài toán phối hợp, đánh đổi về tính nhất quán và những lần production issue lúc 3 giờ sáng. Bối cảnh đó định hình những gì mình viết ở đây nhưng cũng không giới hạn nó.',
				'Nội dung ở mục này có hai dạng. Đôi khi là giải thích: mình lấy thứ gì đó mình hiểu và viết ra cho đến khi người khác có thể hiểu được. Đôi khi là một sản phẩm: một thư viện, một công cụ, một hệ thống, thứ gì đó bạn có thể thực sự chạy được.',
				'Phạm vi của mục này có thể nói là rất rộng. Một thuật toán làm mình ngạc nhiên, một dự án OSS mình bắt đầu, một giao thức phân tán mình dành cả tuần để đọc, một tiện ích nhỏ giải quyết đúng một vấn đề, nếu nó đủ thú vị để viết, nó sẽ ở đây.',
			],
			starters: [],
			scratchpad: [],
		},
	...
	philosophy: {
		...
		vi: {
			...
			intro: [
				'Mình đến với triết học không phải qua lớp học mà qua những câu hỏi cứ quanh quẩn trong đầu mình. Tự do là gì? Sống tốt là sao? Còn lại gì của bản thân khi bạn lột bỏ hết những thói quen? Đây không phải là những câu hỏi mới, có lẽ mọi trường phái đều đã có câu trả lời cho chúng, nhưng những câu trả lời cứ tiếp tục làm mình ngạc nhiên.',
				'Những trường phái mình quan tâm nhất: Chủ nghĩa khắc kỷ, vì những gì nó nói về kiểm soát và chấp nhận; Chủ nghĩa hiện sinh, vì những gì nó nói về tự do và sức nặng của việc lựa chọn; triết học nhà Phật, vì những gì nó nói về sự chú ý và bản chất của đau khổ. Mình không trung thành với trường phái nào. Câu hỏi quan trọng hơn trường phái.',
				'Mình nghĩ triết học là những gì xảy ra khi sự tò mò từ chối sự nông cạn. Nếu bạn cứ hỏi "tại sao" về một chứng minh, một hệ thống, một bộ phim, một cảm xúc, cuối cùng bạn sẽ đến nơi mà sách giáo khoa gọi là triết học. Những bài viết này là những gì mình tìm thấy ở đó.',
			],
			starters: [],
			scratchpad: [],
		},
	...
	art: {
		...
		vi: {
			...
			intro: [
				'Disclaimer mình không phải là một nhà phê bình nghệ thuật cũng sẽ không bao giờ là. Mình viết về nghệ thuật theo cách mình muốn được đọc về nó, cảm nhận về nó.',
				'Trọng tâm ở đây là điện ảnh, tiểu thuyết, và âm nhạc. Vẫn như những mục khác ba cái đó cũng không phải giới hạn của mục này.',
			],
			starters: [],
			scratchpad: [],
		},
	...
	thinking: {
		...
		vi: {
			...
			intro: [
				'Mục này là nơi mình ghi lại những suy nghĩ của riêng bản thân, có thể là kinh nghiệm, lời khuyên hoặc đơn giản là một suy nghĩ vu vơ.',
				'Các bài ở đây sẽ thường ngắn. Chúng không tranh luận và không kết luận, chỉ đơn giản là ghi lại.',
	...
	notes: {
		...
		vi: {
			...
			intro: [
				'Quick Notes của mình, cơ bản là về nhiều thứ nhưng chủ yếu là từ những gì mình đọc, nghe.',
				'Mỗi ghi chú bắt đầu từ một nguồn: một cuốn sách, một bài báo, một tiểu luận, đôi khi chỉ là một câu. Không quá câu nệ hình thức tại đây.',
				'Tiếp nhận là một nửa của cuộc đối thoại. Ở đây là nửa của mình.',
			],
			starters: [],
			scratchpad: [],
		},
